...
class Leads extends CRMEntity {
	...
	*/
	...
	function get_payments($id, $cur_tab_id, $rel_tab_id, $actions=false){
		...
		" INNER JOIN vtiger_leaddetails ON vtiger_leaddetails.leadid = vtiger_payment.parentid ".
		" LEFT JOIN vtiger_groups	ON vtiger_groups.groupid = vtiger_crmentity.smownerid " .
		" LEFT JOIN vtiger_users ON vtiger_crmentity.smownerid = vtiger_users.id ".
		" WHERE vtiger_crmentity.deleted = 0 AND vtiger_leaddetails.leadid = ".$id." GROUP BY vtiger_payment.paymentid ";
