				...
				<div class="row">
					<div class="col-lg-10">
						<div class="input-group" style="width:100%">
							...
							<div class="col-lg-2">								{if $MODULE eq 'SalesOrder'}																		{if $row_no eq 0}										<i class="lineItemPopup cursorPointer vicon-services" data-popup="ServicesPopup" title="{vtranslate('Services',$MODULE)}" data-module-name="Services" data-field-name="serviceid"></i>										<i class="lineItemPopup cursorPointer vicon-products" data-popup="ProductsPopup" title="{vtranslate('Products',$MODULE)}" data-module-name="Products" data-field-name="productid"></i>									{elseif $entityType eq '' and $SERVICE_ACTIVE eq 'true'}										<i class="lineItemPopup cursorPointer vicon-services" data-popup="ServicesPopup" data-module-name="Services" title="{vtranslate('Services',$MODULE)}" data-field-name="serviceid" ></i>									{elseif $entityType eq '' and $PRODUCT_ACTIVE eq 'true'}										<i class="lineItemPopup cursorPointer vicon-products" data-popup="ProductsPopup" data-module-name="Products" title="{vtranslate('Products',$MODULE)}" data-field-name="productid"></i>									{else}										{if ($entityType eq 'Products') and (!$data.$productDeleted)}											<i class="lineItemPopup cursorPointer vicon-products" data-popup="ProductsPopup" data-module-name="Products" title="{vtranslate('Products',$MODULE)}" data-field-name="productid" ></i>										{elseif (!$data.$productDeleted)}											<i class="lineItemPopup cursorPointer vicon-services" data-popup="ServicesPopup" data-module-name="Services" title="{vtranslate('Services',$MODULE)}" data-field-name="serviceid" ></i>										{/if}									{/if}																{else}								
									{if $row_no eq 0}
