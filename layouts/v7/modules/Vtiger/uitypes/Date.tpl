...
<span class="input-group-addon"><i class="fa fa-calendar "></i></span>
  ...
  {if $MODULE eq "Salary" AND $BLOCK_LABEL eq "Deductions Information"}        
    <span class="btn-group">
        <button type="button" class="btn addButton" id="adddates">
            <i class="fa fa-plus"></i>
        </button>
    </span>
    <span class="btn-group">
        <button type="button" class="btn addButton" id="hidedates" >
