...
$languageStrings = array(
	...
	'LBL_TASK_TITLE'               => 'Ação Título'              ,
	'LBL_ADD_TASKS_FOR_WORKFLOW'   => 'Adicionar Ação para fluxo de trabalho',
	...
	'Invoke Custom Function'	   => 'Chamar função personalizada',
	'Create Todo'				   => 'Criar Todo',
	'Create Event'				   => 'Criar Evento',
	'Update Fields'				   => 'Atualização de Campos',
	'Create Entity'                => 'Criar Registro'              ,
	'SMS Task'					   => 'SMS Task',
	'Mobile Push Notification'	   => 'Móvel Push Notification',
	'LBL_ACTION_TYPE' => 'Tipo de Ação (Contagem Ativa)',
	'LBL_VTEmailTask' => 'O Email',
    'LBL_VTEntityMethodTask' => 'Função Personalizada',
    'LBL_VTCreateTodoTask' => 'Tarefa',
    'LBL_VTCreateEventTask' => 'Evento',
    'LBL_VTUpdateFieldsTask' => 'Campo Atualização',
    'LBL_VTSMSTask' => 'SMS', 
    'LBL_VTPushNotificationTask' => 'Notificação móvel',
    'LBL_VTCreateEntityTask' => 'Criar Registro',

  'LBL_EDITING_WORKFLOW' => 'Fluxo De Trabalho De Edição',
  'LBL_ADD_RECORD' => 'Novo Fluxo De Trabalho',
  'ON_SCHEDULE' => 'Programação',
  'LBL_RUN_WORKFLOW' => 'Executar Fluxo De Trabalho',
  'LBL_AT_TIME' => 'No Momento',
  'LBL_HOURLY' => 'De hora em hora',
  'ENTER_FROM_EMAIL_ADDRESS' => 'Introduza um endereço De email',
  'LBL_DAILY' => 'Diária',
  'LBL_WEEKLY' => 'Semanal',
  'LBL_ON_THESE_DAYS' => 'Por estes dias',
  ...
  'LBL_SELECT_MONTH_AND_DAY' => 'Selecione o Mês e a Data',
  'LBL_SELECTED_DATES' => 'As Datas Escolhidas',
  'LBL_EXCEEDING_MAXIMUM_LIMIT' => 'Limite máximo excedido',
  'LBL_NEXT_TRIGGER_TIME' => 'Próximo período de tempo no',
  'LBL_MESSAGE' => 'Mensagem',
  'LBL_WORKFLOW_NAME' => 'Nome Do Fluxo De Trabalho',
  'LBL_TARGET_MODULE' => 'Módulo-Alvo',
  'LBL_WORKFLOW_TRIGGER' => 'Fluxo De Trabalho De Trigger',
  'LBL_TRIGGER_WORKFLOW_ON' => 'Trigger Fluxo De Trabalho Em',
  'LBL_RECORD_CREATION' => 'Criação Do Registro',
  'LBL_RECORD_UPDATE' => 'Atualização Do Registro De',
  'LBL_TIME_INTERVAL' => 'Intervalo De Tempo',
  'LBL_RECURRENCE' => 'Recorrência',
  'LBL_FIRST_TIME_CONDITION_MET' => 'Apenas a primeira vez que condições são atendidas',
  'LBL_EVERY_TIME_CONDITION_MET' => 'Cada vez que condições são atendidas',
  'LBL_WORKFLOW_CONDITION' => 'Condição De Fluxo De Trabalho',
  'LBL_WORKFLOW_ACTIONS' => 'Ações De Fluxo De Trabalho',
  'LBL_DELAY_ACTION' => 'Atraso De Ação',
  'LBL_FREQUENCY' => 'Frequência',
  'LBL_SELECT_FIELDS' => 'Selecione Os Campos',
  'LBL_INCLUDES_CREATION' => 'Inclui A Criação De',
  'LBL_ACTION_FOR_WORKFLOW' => 'Ação de Fluxo de trabalho',
  'LBL_WORKFLOW_SEARCH' => 'Procura por Nome',

);
$jsLanguageStrings = array(
	'JS_STATUS_CHANGED_SUCCESSFULLY' => 'Status changed Successfully' , // TODO: Review
	'JS_TASK_DELETED_SUCCESSFULLY' => 'Ação excluído com sucesso',
    ...
    'JS_CHECK_START_AND_END_DATE'=>'Data e hora final deve ser maior ou igual a Data de Início e Hora',

  'JS_TASK_STATUS_CHANGED' => 'Status da tarefa alterada com êxito.',
  'JS_WORKFLOWS_STATUS_CHANGED' => 'Status do fluxo de trabalho alterada com êxito.',
  'VTEmailTask' => 'Enviar E-Mail',
  'VTEntityMethodTask' => 'Invocar A Função Personalizada',
  'VTCreateTodoTask' => 'Criar Tarefa',
  'VTCreateEventTask' => 'Criar Evento',
  'VTUpdateFieldsTask' => 'Atualização De Campos',
  'VTSMSTask' => 'SMS de Tarefas',
  'VTPushNotificationTask' => 'Móveis De Notificação De Envio',
  'VTCreateEntityTask' => 'Criar Registo',
  'LBL_EXPRESSION_INVALID' => 'Expressão Inválido',
