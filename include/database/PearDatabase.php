...
class PearDatabase{
    ...
    function createTables($schemaFile, $dbHostName=false, $userName=false, $userPassword=[DB_PASSWORD]
		...
		if($userPassword!=false) $this->userPassword=[DB_PASSWORD];
